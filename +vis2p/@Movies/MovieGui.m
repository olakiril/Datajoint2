...
% MOVIEGUI M-file for MovieGui.fig
...
%
%      MOVIEGUI('CALLBACK',hObject,eventData,handles,...) calls the local
...
% Last Modified by GUIDE v2.5 25-Apr-2011 10:59:55
...
function MovieGui_OpeningFcn(hObject, eventdata, handles, varargin)
...
% so window can get raised using MovieGui.
...
function varargout = MovieGui_OutputFcn(hObject, eventdata, handles)
